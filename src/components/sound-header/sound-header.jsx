...
import styles from './sound-header.css';
...
const SoundHeaderComponent = function (props) {
    const {
        isFullScreen,
        isPlayerOnly,
        onKeyPress,
...
SoundHeaderComponent.propTypes = {
    intl: intlShape,
...
SoundHeaderComponent.defaultProps = {
    stageSizeMode: STAGE_SIZE_MODES.large
};

export default injectIntl(connect(
    mapStateToProps
)(SoundHeaderComponent));
